...
For the retirement account, we converted the asset to an income stream using monthly payments that were sufficiently large that they are expected to drain the retirement account before the applicant dies, using a social security administration (SSA) actuarial table.
